...
<div class="jumbotron" id="jumbotronDiv">
  <div class="container-fluid">
    <div class="row align-items-center">
      <div class="col-lg-7">
        <h1 id="jumbotronTeddybear"class="text-center jumbotronTeddybear" style=" font-family:Amatic SC, cursive; color:SlateBlue; text-shadow: 1.5px 1px FireBrick; font-weight=bold">Teddy Bear</h1>
        <br>
        <h4 class="text-center" id="jumbotronLove" style="font-family:Amatic SC, cursive; color:SlateBlue;"><i>A friend for life</i></h4>
        <br>
      </div>
    </div>
    <!--div row--> 
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-8"> <br>
      <br>
      <br>
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <img src="images\teddy-2439215__340.jpg" class="img-fluid rounded"> </div>
    <!--div col--> 
  </div>
  <!--div row--> 
</div>
